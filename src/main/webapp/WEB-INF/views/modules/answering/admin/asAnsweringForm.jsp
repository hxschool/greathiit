...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/answering/admin/asAnswering/form?id=${asAnswering.id}">答辩抽签<shiro:hasPermission name="answering:admin:asAnswering:edit">${not empty asAnswering.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="answering:admin:asAnswering:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="asAnswering" action="${ctx}/answering/admin/asAnswering/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">计划编码：</label>
			<div class="controls">
				<form:input path="courseScheduleId" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="timeAdd" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="teacherIds" htmlEscape="false" maxlength="1280" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="answering:admin:asAnswering:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
