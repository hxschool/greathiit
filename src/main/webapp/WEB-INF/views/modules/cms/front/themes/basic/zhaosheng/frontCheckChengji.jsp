													...
													<div class="span6">
														...
														<div class="control-group ">
															...
															<div class="controls">
																...
																<input type="text" name="hcFormCj" value="${systemStudent.hcFormXm }" style="border: 0px;"/>
														...
														<div class="control-group ">
															...
															<div class="controls">
																...
																<input type="text" name="hcFormCj" value="${systemStudent.hcFormSfzh }" style="border: 0px;"/>
														...
														<div class="control-group ">
															...
															<div class="controls">
																...
																<input type="text" name="hcFormCj" value="${systemStudent.hcFormAdd1 }" style="border: 0px;"/>
														...
														<div class="control-group ">
															...
															<div class="controls">
																...
																<input type="text" name="hcFormCj" value="${systemStudent.hcFormAdd2 }" style="border: 0px;"/>
														...
														<div class="control-group ">
															...
															<div class="controls">
																...
																<input type="text" name="hcFormCj" value="${systemStudent.hcFormBaojiuye }" style="border: 0px;"/>
														...
														<div class="control-group ">
															...
															<div class="controls">
																...
																<input type="text" name="hcFormCj" value="${systemStudent.hcFormCj }"  style="border: 0px;"/>
