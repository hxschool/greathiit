...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/course/courseSpecificContent/">课程内容列表</a></li>
		<shiro:hasPermission name="course:courseSpecificContent:edit"><li><a href="${ctx}/course/courseSpecificContent/form">课程内容添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="courseSpecificContent">
			<tr>
				...
				<shiro:hasPermission name="course:courseSpecificContent:edit"><td>
					...
					<a href="${ctx}/course/courseSpecificContent/delete?id=${courseSpecificContent.id}" onclick="return confirmx('确认要删除该课程内容吗？', this.href)">删除</a>
