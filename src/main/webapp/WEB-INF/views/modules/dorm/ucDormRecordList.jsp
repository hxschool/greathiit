...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/dorm/ucDormRecord/">查寝记录列表</a></li>
		<shiro:hasPermission name="dorm:ucDormRecord:edit"><li><a href="${ctx}/dorm/ucDormRecord/form">查寝记录添加</a></li></shiro:hasPermission>
	</ul>
