			...
			$("#allcheckbox").click(function() {
				if (this.checked) {
					...
					$("input[name='ids']").each(function(index,element){
						var ret = parseFloat($("#T"+$(this).attr("id")).val());
						var amount = parseFloat($("#allAmount").html());
						$("#allAmount").html(ret+amount);
					})
...
<body>
<form id="inputForm" action="${ctx }/payment/pay.html" method="post" class="basic-grey">
		
		
		<h1>
				信息核实 <span>请核对缴费信息</span>
			</h1>
		...
		<table class="bordered">
			...
			<c:forEach items="${list}" var="paymentEntity" varStatus="i">
				<tr>
					<td><input type="checkbox" name="ids" id="${paymentEntity.id}"
						value="${paymentEntity.id}"> <input type="hidden"
