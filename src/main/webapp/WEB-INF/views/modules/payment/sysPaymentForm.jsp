...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/payment/sysPayment/">全局缴费配置列表</a></li>
		<li class="active"><a href="${ctx}/payment/sysPayment/form?id=${sysPayment.id}">全局缴费配置<shiro:hasPermission name="payment:sysPayment:edit">${not empty sysPayment.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="payment:sysPayment:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysPayment" action="${ctx}/payment/sysPayment/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">缴费类型：</label>
			<div class="controls">
				<form:input path="paymentTypeId" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="payment:sysPayment:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
