...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/student/studentCourse/form?id=${studentCourse.id}">学生成绩<shiro:hasPermission name="student:studentCourse:edit">${not empty studentCourse.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="student:studentCourse:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="studentCourse" action="${ctx}/student/studentCourse/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="student:studentCourse:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
