			...
			<div class="span12 div-content-white-bgr">
				...
				<form class="form-horizontal" enctype="multipart/form-data"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="teacher.tchrName"
								value="${teacher.tchrName}"> <!-- <label class="lable-modify"
					...
					<div class="control-group">
						...
						<textarea name="teacher.tchrSelflIntroduction"
						...
						<tbody id="tbody-exp">
							<c:forEach var="e" items="${teacherExperiments}"
								...
								<tr>
									...
									<td>${e.tchrTime }</td>
									<td><a
										href="Teacher_Information_Modify_deleteExpById?expId=${#e.tchrExpId}">删除</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
