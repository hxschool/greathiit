...
<head>
  ...
  <link rel="stylesheet" href="${ctxStatic}/wechat/css/style.css">
</head>
...
<script src="${ctxStatic}/wechat/js/zepto.min.js"></script>
<script src="${ctxStatic}/wechat/js/demo.js"> </script>
</html>
