          ...
          用户登录
            ...
            <div class="modal-body">
				...
				<div >
					<div class="row">
							<div class="col-md-12">
									<form action="http://login.greathiit.com/login?service=http://www.greathiit.com/a" name="form1" method="post" id="loginForm" onsubmit="return loginValidate();"   class="form-horizontal"></form>
									<fieldset>
									  <div id="legend" class="">
										<legend class="">
...
<p  style="font-size:12px;">2、现场报到：请按录取通知书要求在指定时间内到校办理现场报到相关手续。</p></legend>
									            ...
									            <div class="col-lg-8 col-lg-offset-2">
													  ...
													  <div class="controls">
														<input placeholder="请输入身份证号码" name="username" class="form-control input-sm" type="text" id="username">  
													  </div>
													</div>
												</div>
												...
												<div class="row" style="margin-bottom:10px;">
													<div class="col-lg-8 col-lg-offset-2">
													  ...
													  <div class="controls">
														<input placeholder="请输入密码"  name="password" class="form-control input-sm" type="password" id="password">  
													  </div>
													</div>
												</div>
												...
												<div class="row" style="margin-bottom:10px;">
													<div class="col-lg-8 col-lg-offset-2">
													  ...
													  <div class="controls">
														...
														<a  href="javascript:void(0);" id="submit_login">  
            <span class="login_btn">点击登录</span>  
            </a>  
...
<div class="modal fade" id="myShuomingModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body"><img src="${ctxStatic}/yingxin2/images/shuoming.png"/></div>
