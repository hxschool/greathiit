...
window.onload = function () {
    ...
    $("#getcode").click(function () {
        ...
        $.ajax({
            ...
            url: "/servlet/mailValidateCodeServlet", // 目标地址    
            data: { "Code": code, "email": phoNum },
            error: function (msg) {
                alert(msg);
            },
            success: function (data) {
                //前台给出提示语
                if (data == "true") {
                    $("#telephonenameTip").html("<font color='#339933'>√ 邮箱验证码已发到您的邮箱,请查收(30分钟内有效)</font>");
                } else if (data == "false") {
    ...
    $("#submit").click(function () {
        ...
        $.ajax({
            ...
            data: { "email":mobile,"CheckCode": CheckCode },
            type: "POST",
            dataType: "text",
            success: function (data) {
                if (data == "true") {
                    ...
                    $("#codenameTip").html("<font color='red'>× 邮箱验证码有误，请核实后重新填写</font>");
                    return;
                }
            }
        });
